...
export function SignupPage() {
  ...
  async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setPassword("");
      navigate(session.role === "candidate" ? "/postings" : "/recruiter/postings", { replace: true });
    } catch (caught) {
